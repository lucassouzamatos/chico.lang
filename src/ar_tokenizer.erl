...
yystate(28, [10|Ics], Line, Tlen, _, _) ->
    yystate(28, Ics, Line+1, Tlen+1, 0, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(17, Ics, Line, Tlen+1, 15, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 120 ->
    yystate(17, Ics, Line, Tlen+1, 15, Tlen);
...
yystate(26, [10|Ics], Line, Tlen, _, _) ->
    yystate(28, Ics, Line+1, Tlen+1, 11, Tlen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(17, Ics, Line, Tlen+1, 11, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 117 ->
    yystate(17, Ics, Line, Tlen+1, 11, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 119, C =< 122 ->
    yystate(17, Ics, Line, Tlen+1, 11, Tlen);
