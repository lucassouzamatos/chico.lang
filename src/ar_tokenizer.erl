...
yystate(52, [10|Ics], Line, Tlen, _, _) ->
    yystate(52, Ics, Line+1, Tlen+1, 0, Tlen);
yystate(52, Ics, Line, Tlen, _, _) ->
    {0,Tlen,Ics,Line,52};
yystate(51, [112|Ics], Line, Tlen, _, _) ->
    yystate(47, Ics, Line, Tlen+1, 20, Tlen);
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
yystate(51, Ics, Line, Tlen, _, _) ->
    {20,Tlen,Ics,Line,51};
yystate(50, [119|Ics], Line, Tlen, _, _) ->
...
yystate(50, [10|Ics], Line, Tlen, _, _) ->
    yystate(52, Ics, Line+1, Tlen+1, 16, Tlen);
...
yystate(50, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(31, Ics, Line, Tlen+1, 16, Tlen);
yystate(50, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 107 ->
    yystate(31, Ics, Line, Tlen+1, 16, Tlen);
yystate(50, [C|Ics], Line, Tlen, _, _) when C >= 110, C =< 118 ->
    yystate(31, Ics, Line, Tlen+1, 16, Tlen);
yystate(50, [C|Ics], Line, Tlen, _, _) when C >= 120, C =< 122 ->
    yystate(31, Ics, Line, Tlen+1, 16, Tlen);
...
yystate(40, [10|Ics], Line, Tlen, _, _) ->
    yystate(48, Ics, Line+1, Tlen+1, 9, Tlen);
...
yystate(36, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 91 ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
yystate(36, [C|Ics], Line, Tlen, Action, Alen) when C >= 95 ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 91 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(24, [10|Ics], Line, Tlen, _, _) ->
    yystate(28, Ics, Line+1, Tlen+1, 1, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(28, Ics, Line, Tlen+1, 1, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 36, C =< 91 ->
    yystate(28, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 91 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(18, [104|Ics], Line, Tlen, _, _) ->
    yystate(14, Ics, Line, Tlen+1, 20, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 91 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 119 ->
    yystate(31, Ics, Line, Tlen+1, 20, Tlen);
...
yyaction_6(TokenLine) ->
     { token, { done, TokenLine, none } } .

-compile({inline,yyaction_7/1}).
-file("./ar_tokenizer.xrl", 18).
yyaction_7(TokenLine) ->
     { token, { match, TokenLine, none } } .

-compile({inline,yyaction_8/1}).
-file("./ar_tokenizer.xrl", 19).
yyaction_8(TokenLine) ->
     { token, { with, TokenLine, none } } .
...
yyaction_10(TokenLine) ->
     { token, { export, TokenLine, export } } .

-compile({inline,yyaction_11/1}).
-file("./ar_tokenizer.xrl", 24).
yyaction_11(TokenLine) ->
     { token, { apply, TokenLine, apply } } .

-compile({inline,yyaction_12/1}).
-file("./ar_tokenizer.xrl", 25).
yyaction_12(TokenLine) ->
